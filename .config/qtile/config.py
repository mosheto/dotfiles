...
groups = [Group("Web (1)", layout='monadtall'),
          Group("Spotify (2)", layout='monadtall'),
          Group("Workout (3)", layout='monadtall'),
          Group("Files (4)", layout='monadtall'),
          Group("Discord (5)", layout='monadtall'),
          Group("Terminal (6)", layout='monadtall'),
          Group("Others (7)", layout='monadtall'),
